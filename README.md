...
* Supports STATUS, STATUS\_EX, and ANALOG messages.
* Clean LED feedback for each state.

### **Deterministic State Machine**

* **BOOT\_DETECT** → Wait for MSP heartbeat
* **PRE\_ARM\_DELAY** → Timer or PWM‑based arming
...
* `config.h` for all user‑tunable parameters.
* Dedicated modules:
...
* INPUT\_PULLDOWN on PWM inputs prevents floating edges.
